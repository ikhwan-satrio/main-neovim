  ...
  -- ============================================================================
  {
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>jc', desc = 'JJ commit' },
        { '<leader>jS', desc = 'JJ squash' },
        { '<leader>ju', desc = 'JJ undo' },
        { '<leader>jy', desc = 'JJ redo' },
        { '<leader>jr', desc = 'JJ rebase' },
        { '<leader>ja', desc = 'JJ abandon' },
        { '<leader>jf', desc = 'JJ fetch' },
